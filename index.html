...
<head>
    <link rel="stylesheet" href="/css/webd2201.css" type="text/css" />
...
<body>
    <div id="container">
        <div id="header">
            <img src="/images/logo.gif" alt="powerj" />
        </div>
        <div id="sites">
            <ul>
        ...
        <div id="content-container">
            ...
            <div id="content">
<p>
    This page was created as an index page for <a href="http://opentech2.durhamcollege.org/pufferd/webd2201/">WEBD2201</a> class at <a href="http://www.durhamcollege.ca/">Durham College</a> to learn basic HTML syntax and begin using headers, paragraphs, images and anchors.
</p>
</div>    
    <div id="footer">
